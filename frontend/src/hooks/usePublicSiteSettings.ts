...
export function useSiteBranding() {
  ...
  return {
    ...
    primaryColor: getSetting(s, 'branding.primary_color', '#4F46E5'),
    secondaryColor: getSetting(s, 'branding.secondary_color', '#0F766E'),
    ...
    sidebarActiveColor: getSetting(s, 'branding.sidebar_active_color', '#4F46E5'),
