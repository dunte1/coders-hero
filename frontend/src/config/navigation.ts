...
const FINANCE_ROLES: NavRole[] = ['super_admin', 'admin', 'director', 'accountant'];
...
export const navigation: NavEntry[] = [
...

  {
    ...
    children: [
      ...
      { label: 'Expenses', href: '/finance/expenses', icon: XCircle },
      { label: 'Budgets', href: '/finance/budgets', icon: BarChart3 },
      { label: 'M-Pesa', href: '/finance/mpesa', icon: Smartphone },
...

  {
    ...
    children: [
      ...
      { label: 'Leave', href: '/hr/leaves', icon: CalendarCheck },
      { label: 'Attendance', href: '/hr/attendance', icon: CalendarCheck },
      { label: 'Payroll', href: '/hr/payrolls', icon: Wallet },
      { label: 'Performance', href: '/hr/reviews', icon: Star },
...

  {
    ...
    children: [
      ...
      { label: 'Assets', href: '/inventory/assets', icon: Cpu },
...

  {
    ...
    children: [
      ...
      { label: 'Resources', href: '/library/admin/resources', icon: FileText, roles: LIBRARY_MANAGE_ROLES },
      { label: 'Borrowings', href: '/library/admin/borrowings', icon: BookOpen, roles: LIBRARY_MANAGE_ROLES },
      { label: 'Reservations', href: '/library/admin/reservations', icon: CalendarCheck, roles: LIBRARY_MANAGE_ROLES },
      { label: 'Categories', href: '/library/admin/categories', icon: BookOpen, roles: LIBRARY_MANAGE_ROLES },
      { label: 'Authors', href: '/library/admin/authors', icon: Users, roles: LIBRARY_MANAGE_ROLES },
    ],
  },
...

  {
    ...
    children: [
      ...
      { label: 'System Health', href: '/admin/system-health', icon: ActivityIcon },
      { label: 'Backups', href: '/admin/backups', icon: Save },
