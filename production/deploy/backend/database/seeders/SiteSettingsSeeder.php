...
class SiteSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['chat.primary_color', 'chat', '#4F46E5'],
            ['chat.enabled', 'chat', '1'],

            ['branding.logo', 'branding', ''],
            ['branding.favicon', 'branding', ''],
            ['branding.primary_color', 'branding', '#4F46E5'],
            ['branding.secondary_color', 'branding', '#0F766E'],
            ...
            ['branding.sidebar_active_color', 'branding', '#4F46E5'],
